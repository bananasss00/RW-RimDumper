...
namespace CSharpCompiler
{
    public class ScriptBundleLoader
    {
        ...
        readonly ISynchronizeInvoke synchronizedInvoke;
        readonly List<ScriptBundle> allFilesBundle = new();
        ...
        public class ScriptBundle
        {
            ...
            readonly ScriptBundleLoader manager = null!;
            readonly string[] assemblyReferences = null!;
