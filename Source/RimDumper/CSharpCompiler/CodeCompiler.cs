...
namespace CSharpCompiler
{
    ...
    public class CodeCompiler : ICodeCompiler
    {
        ...
        private CompilerResults CompileFromDomBatch(CompilerParameters options, CodeCompileUnit[] ea)
        {
            ...
            //     FileStream f = new(fileNames[i], FileMode.OpenOrCreate);
            //     StreamWriter s = new(f, Encoding.UTF8);
        ...
        public CompilerResults CompileAssemblyFromSourceBatch(CompilerParameters options, string[] sources)
        {
            ...
            {
                Stream getStream() { return new MemoryStream(Encoding.UTF8.GetBytes(source ?? "")); }
